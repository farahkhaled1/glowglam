...
$name = $email = $linkk = $country = $suggestion = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($name_err) && empty($email_err) && empty($linkk_err) && empty($country_err) && empty($suggestion_err)) {
        ...
        $sql = "INSERT INTO suggestion (name,email,link,country, suggestion) VALUES (?,?,?,?,?)";

        if ($stmt = mysqli_prepare($link, $sql)) {
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ssss", $param_name, $param_email, $param_linkk, $param_country, $param_suggestion);
